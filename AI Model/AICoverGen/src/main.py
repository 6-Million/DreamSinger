...
sys.path.append(os.path.abspath(__file__).replace("main.py", ""))
...
def song_cover_pipeline(song_input, voice_model, output_path, pitch_change, keep_files,
...
if __name__ == '__main__':
    ...
    print(args.song_input, rvc_dirname)

    if not os.path.exists(os.path.join(rvc_models_dir, rvc_dirname)):
        raise Exception(f'The folder {os.path.join(rvc_models_dir, rvc_dirname)} does not exist.')

    print(args.song_input, rvc_dirname)
    cover_path = song_cover_pipeline(args.song_input, rvc_dirname, args.output_path, args.pitch_change, args.keep_files,
